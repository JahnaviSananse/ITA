...
import index from '../../components/atoms/Searchbar';
...
class Fund extends Component {
            ...
            >
               <View style={styles.searchbarContainer}>
                  ...
                  <TouchableOpacity
                     ...
                     {this.state.searchText !== '' && <Image style={{ height: 20, width: 20 }} source={IMG.CLEAR} />}
                  </TouchableOpacity>
               </View>
               <TouchableOpacity
                  onPress={() => {
   ...
   render() {
      let filterCount = this.state.assestClass.length + this.state.investmentUniverse.length + this.state.fundFamily.length
      ...
      return (
         <SafeAreaView style={{ flex: 1, backgroundColor: utility.changeHeaderColor('#F3F3F3') }}>
            <View style={styles.container}>
               <View style={{ width: '100%', backgroundColor: utility.changeBackgroundColor('#E2E2E2'), }}>
                  <Header
                           ...
                           return (
                              <View tabLabel={{ label: `${value.display_name}` }} >
                                 <View style={[styles.containerList, {
                                    ...
                                    >
                                       <FundList data={this.props.fund} navigation={this.props.navigation} />
                                    </View>
                                 </View>
                              </View>
                           )
                  ...
                  <TouchableOpacity
                     ...
                     <FastImage style={{ height: 22, width: 22 }}
