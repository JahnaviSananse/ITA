...
import { View, Switch, Text, SafeAreaView, AsyncStorage } from 'react-native';
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: utility.changeHeaderColor('#F3F3F3') }}>
                <View style={[styles.container, {
                    ...
                    <View style={styles.switchContainer}>
                        ...
                        }]}>{language.TouchID}</Text>
                        <Switch onTintColor="#87B1B4" style={styles.switchStyle} onValueChange={this.toggleSwitch} value={this.state.switchValue} />
                    </View>
                    <View style={styles.textContainer}>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.TouchIdMessage}</Text>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.TouchIdWarning}</Text>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.TouchIdTurnOff}</Text>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.TouchIdTradeMark}</Text>
                    </View>
                </View >
            </SafeAreaView>
        );
