...
class Login extends React.Component {
  ...
  onPrivacyClick() {
    ...
    data.file_url = "https://www.creolestudios.com/privacy-policy/";
          ...
          >
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  style={styles.loginAsGuestContainer}
                  onPress={() => this.onContinueAsGuestClick()}
                >
                  <Text style={styles.loginAsGuestText}>
                    {language.ContinueAsGuest}
                  </Text>
              ...
              <View style={styles.copyRightContainer}>
                ...
                <Text style={styles.copyRightText}>
                  {language.CopyRight} Version {version}
                </Text>
              </View>
            </Animated.View>
