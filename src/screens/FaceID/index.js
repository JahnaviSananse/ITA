            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: utility.changeHeaderColor('#F3F3F3') }}>
                <View style={[styles.container, {
                    ...
                    <View style={styles.switchContainer}>
                        ...
                        }]}>{language.FaceID}</Text>
                        <Switch onTintColor="#87B1B4" style={styles.switchStyle} onValueChange={this.toggleSwitch} value={this.state.switchValue} />
                    </View>
                    <View style={styles.textContainer}>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.FaceIdMessage}</Text>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.FaceIdWarning}</Text>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.FaceIdTurnOff}</Text>
                        <Text style={[styles.descText, { color: utility.changeFontColor("#6b6b6a") }]}>{language.FaceIdTradeMark}</Text>
                    </View>
                </View >
            </SafeAreaView>
        );
