...
class ImageScreen extends Component {
	...
	componentWillMount() {
		...
		this.setState({
			imgURL: this.props.navigation.getParam('image'),
					...
					>
						<View style={{ flexDirection: 'row' }}>
							<FastImage
								resizeMode={FastImage.resizeMode.contain}
								style={styles.icon}
								source={isFav === true ? images.BOOKMARK_SELECTED : images.BOOKMARK_UNSELECTED}
							/>
						</View>
						<View style={styles.textContainer}>
...
export default connect(mapStateToProps, { addRemoveFavorite, clearData, getFavoriteList, shareData })(ImageScreen);
