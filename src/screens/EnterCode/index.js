              ...
              <View style={styles.formContainer}>
                <View style={styles.titleContainer}>
                  <Text style={styles.titleText}>
                    {language.EnterConfirmationCode}
                  </Text>
                  <Text style={styles.titleDesc}>
                    {language.Enter6DigitCode} {email}.
                  </Text>
                </View>
                ...
                <View style={{ marginTop: 10 }}>
                  ...
                  <TouchableOpacity onPress={() => this.resendCode()}>
                    {utility.recordEvent(
                      "Enter code: Request new one button pressed"
                    )}
                    <Text style={styles.requestNewText}>
                      {language.RequestNewOne}
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
...
export default connect(mapStateToProps, { confirmationCode, resendCode })(
  EnterCode
);
